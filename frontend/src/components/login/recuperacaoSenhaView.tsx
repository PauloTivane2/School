  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-yellow-50 to-orange-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-[280px] p-4 flex flex-col items-center">
        ...
        <h2 className="text-xl font-bold text-yellow-700 mb-3 text-center">Recuperação de Senha</h2>
        ...
        <div className="w-full space-y-2">
          <div>
            ...
            <input
              ...
              className="w-full px-2 py-1.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:outline-none text-sm"
            />
          </div>
          ...
          <div className="flex gap-2 mt-3">
            <button
              onClick={onBack}
              className="flex-1 px-2 py-1.5 bg-gray-400 hover:bg-gray-500 text-white rounded-lg text-sm font-medium"
            >
              Voltar
            </button>
            <button
              onClick={handleConfirm}
              className="flex-1 px-2 py-1.5 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg hover:from-yellow-600 hover:to-orange-600 text-sm font-medium"
            >
              Confirmar
            </button>
          </div>
