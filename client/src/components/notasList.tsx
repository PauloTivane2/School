                        ...
                        {alunos.map(a=>(
                          <tr key={a.id} className="hover:bg-neutral-bg/50">
                            ...
                            <td className={`px-3 py-1 text-center font-bold ${
                              (a.notaFrequencia ?? 0) >= 10 ? 'text-success' : 'text-primary'
                            }`}>
                            ...
                            {/* Média */}
                            <td className={`px-3 py-1 text-center font-bold ${
                              (a.mediaFinal ?? 0) >= 10 ? 'text-success' : 'text-primary'
                            }`}>
