...
export default function AlunosFormPage({ student, onClose, onSuccess }: StudentFormProps) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mt-10 mb-10">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t-2">
            ...
            <button type="submit" disabled={saving} className="px-6 py-2 btn-success disabled:opacity-50 flex items-center gap-2">
